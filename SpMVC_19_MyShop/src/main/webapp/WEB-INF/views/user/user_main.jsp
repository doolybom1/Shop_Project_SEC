		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a class="nav-link" href="${rootPath}/user/product/cart_view">장바구니</a>
	...
	<section class="container">
		<c:choose>
			<c:when test="${BODY == 'B2C_DETAIL'}">
				<%@ include file = "/WEB-INF/views/user/user_detail.jsp" %>
			</c:when>

			<c:when test="${BODY == 'CART_VIEW'}">
				<%@ include file = "/WEB-INF/views/user/cart_view.jsp" %>
			</c:when>
			<c:otherwise>
				<%@ include file = "/WEB-INF/views/user/user_list.jsp" %>
			</c:otherwise>
		</c:choose>
