...
/**
 * Spring Security기반 회원가입 및 email 인증 프로젝트 메인 컨트롤러
 * 
 * @since 2020-04-20
 * @author dooly
 * 
...
public class JoinController {
	 ...
	 * localhost/sec/admin : 회원가입 화면보이기
	 ...
	 * join/join_last : email 인증 후 이후처리
	 * 
	 * @param userVO
	 * @param model
	 * @return
	 ...
	 * userVO의 데이터를 받아서 sessionAttributes에 설정된 저장소에 저장해두고 이메일 인증 화면 보여주기 
	 * 
	 * @param userVO
	 * @return
	 */
