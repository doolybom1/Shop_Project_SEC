...
public class BBsController {
	 ...
	 * 		버튼이 2개 있다.
	 * - 그 중 저장(글쓰기) 버튼에는 아무런 type로 지정하지 않았기 때문에
...
//		}
	...
	public String fileUp(MultipartFile upFile) {
		...
		// 파일이 정상적으로 업로드가 안되면 retFileName이 null값이 되기때문에 이를 대비하기 위해
		if(retFileName == null) {
			return "FAIL";
		}
		return retFileName;	
